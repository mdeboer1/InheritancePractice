...
public class SalaryPlusCommisionEmployee extends SalariedEmployee {
    ...
    */
    ...
    public SalaryPlusCommisionEmployee(String fName, String lName, String hireDate, 
    ...
    */
    ...
    public String toString(){
        String response = "The first employee's name is: " + this.getFirstName() +
                ...
                ".  Their salary is: " + this.getSalary() + ".  Their commision "
                + "percentage is: " + this.getCommisionPercentage() +" .  Their"
                + " total commisionable sales is: " + this.getCommisionedSalesAmount() +
